...
import { BookCheck, Mail, Phone, MapPin } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <BookCheck className="h-6 w-6 text-indigo-400" />
              <span className="font-bold text-xl">Bridge Connect</span>
            </div>
            <p className="text-gray-300 text-sm mb-4">
              Helping lateral entry students integrate seamlessly into college life with peer support and resources.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/peer-mentoring" className="text-gray-300 hover:text-white transition-colors duration-200">Peer Mentoring</Link>
              </li>
              <li>
                <Link to="/academic-support" className="text-gray-300 hover:text-white transition-colors duration-200">Academic Support</Link>
              </li>
              <li>
                <Link to="/video-resources" className="text-gray-300 hover:text-white transition-colors duration-200">Video Resources</Link>
              </li>
              <li>
                <Link to="/community-forum" className="text-gray-300 hover:text-white transition-colors duration-200">Community Forum</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-300">University Campus, 123 College Ave, Education City</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-indigo-400 flex-shrink-0" />
                <span className="text-gray-300">support@bridgeconnect.edu</span>
              </li>
              <li className="flex items-center space-x-3">
